...
struct Z_CompiledInDeferFile_FID_Projects_DemoJob_Plugins_Inventory_Source_Inventory_Public_Widgets_Inventory_SlottedItems_Inv_EquippedSlottedItem_h__Script_Inventory_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UInv_EquippedSlottedItem, UInv_EquippedSlottedItem::StaticClass, TEXT("UInv_EquippedSlottedItem"), &Z_Registration_Info_UClass_UInv_EquippedSlottedItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInv_EquippedSlottedItem), 1179148736U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_DemoJob_Plugins_Inventory_Source_Inventory_Public_Widgets_Inventory_SlottedItems_Inv_EquippedSlottedItem_h__Script_Inventory_2826802788(TEXT("/Script/Inventory"),
